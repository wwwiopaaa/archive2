...
public final class MetaDataUtils {
     ...
     * @return the value of meta-data in application
     */
    public static String getMetaDataInApp(Context context,@NonNull final String key) {
        String value = "";
     ...
     * @return the value of meta-data in activity
     */
    public static String getMetaDataInActivity(Context context,@NonNull final Activity activity,
                                               @NonNull final String key) {
        return getMetaDataInActivity(context,activity.getClass(), key);
    }
     ...
     * @return the value of meta-data in activity
     */
    public static String getMetaDataInActivity(Context context,@NonNull final Class<? extends Activity> clz,
                                               @NonNull final String key) {
        String value = "";
        PackageManager pm = context.getPackageManager();
     ...
     * @return the value of meta-data in service
     */
    public static String getMetaDataInService(Context context,@NonNull final Service service,
                                              @NonNull final String key) {
        return getMetaDataInService(context,service.getClass(), key);
    }
     ...
     * @return the value of meta-data in service
     */
    public static String getMetaDataInService(Context context,@NonNull final Class<? extends Service> clz,
                                              @NonNull final String key) {
        String value = "";
        PackageManager pm = context.getPackageManager();
        ComponentName componentName = new ComponentName(context, clz);
     ...
     * @return the value of meta-data in receiver
     */
    public static String getMetaDataInReceiver(Context context,@NonNull final Class<? extends BroadcastReceiver> clz,
                                               @NonNull final String key) {
        String value = "";
        PackageManager pm = context.getPackageManager();
        ComponentName componentName = new ComponentName(context, clz);
